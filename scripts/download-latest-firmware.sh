...
echo "- For Standard Mode: eyelash_sofle_studio_left + eyelash_sofle_standard_right"
echo "- For Dongle Mode: alliecatkeeb_dongle_central + left/right peripherals"
echo "- For Reset: settings_reset_* files"
echo ""
